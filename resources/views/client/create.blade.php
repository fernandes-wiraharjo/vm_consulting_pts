        ...
        <form method="POST" action="{{ route('client::store') }}">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control @if ($errors->has('code')) is-invalid @endif" name="code" value="{{ old('code') }}">
              @if($errors->has('code'))
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="number" class="form-control @if ($errors->has('phone')) is-invalid @endif" name="phone" value="{{ old('phone') }}">
              @if($errors->has('phone'))
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control @if ($errors->has('pic')) is-invalid @endif" name="pic" value="{{ old('pic') }}">
              @if($errors->has('pic'))
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <textarea name="address" class="form-control @if ($errors->has('address')) is-invalid @endif">{{ old('address') }}</textarea>
