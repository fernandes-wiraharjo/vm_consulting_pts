  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ route('project-tracking::create') }}" class="btn btn-sm btn-primary">Add</a>
      </div>
      <div class="card-body">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure want to <strong id="status"></strong> job number <strong id="name"></strong>?
      </div>
...
@section('js')
@vite('resources/js/project-tracking/index.js')
@endsection
