...
<div class="row">
  <div class="col-lg-12 col-md-12 col-12">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
      <h3 class="mb-0 ">Add Daily Task</h3>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <form method="POST" action="{{ route('daily-task::store') }}">
          @csrf
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <select class="form-select @if ($errors->has('job_number')) is-invalid @endif" name="job_number">
                ...
                @foreach ($jobs as $job)
                <option value="{{ $job->id }}" {{ (collect(old('job_number'))->contains($job->id)) ? 'selected':'' }}>{{ $job->code }}</option>
                @endforeach
              </select>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" name="date" class="form-control date @if ($errors->has('date')) is-invalid @endif" value="{{ old('date') ?? request()->get('date') }}">
              @if($errors->has('date'))
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" name="hour" class="form-control hour @if ($errors->has('hour')) is-invalid @endif" value="{{ old('hour') }}">
              @if($errors->has('hour'))
